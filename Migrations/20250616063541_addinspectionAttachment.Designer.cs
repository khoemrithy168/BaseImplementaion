...
namespace BOM.API.Migrations
{
    ...
    [Migration("20250616063541_addinspectionAttachment")]
    partial class addinspectionAttachment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormCheckRecordAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CheckedRecordID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CheckedRecordID");

                    b.ToTable("ef_boq_inspection_form_item_check_record_attachment");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormCheckRecordAttachment", b =>
                {
                    b.HasOne("ModelLayer.InspectionFormItemCheckRecord", "ItemCheckRecord")
                        .WithMany("CheckAttachments")
                        .HasForeignKey("CheckedRecordID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ItemCheckRecord");
                });
