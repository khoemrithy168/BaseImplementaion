...
namespace BOM.API.Migrations
{
    ...
    [Migration("20250617095735_changerEntityRelationship")]
    partial class changerEntityRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelLayer.InspectionForm", b =>
                {
                    ...
                    b.ToTable("ef_boq_site_inspection_form");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormGroupRecord", b =>
                {
                    ...
                    b.Property<int?>("InspectionFormItemGroupId")
                        .HasColumnType("int");

                    b.Property<int?>("InspectionFormRecordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InspectionFormItemGroupId");

                    b.HasIndex("InspectionFormRecordId");

                    b.ToTable("ef_boq_site_inspection_form_group_record");
                });

            modelBuilder.Entity("ModelLayer.InspectionFormGroupRecordAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FormGroupRecordId")
                        .HasColumnType("int");

                    b.Property<int?>("InspectionFormItemCheckRecordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InspectionFormItemCheckRecordId");

                    b.ToTable("ef_boq_inspection_form_group_record_attachment");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormItemCheckList", b =>
                {
                    ...
                    b.ToTable("ef_boq_site_inspection_form_item_checklist");
                });

            modelBuilder.Entity("ModelLayer.InspectionFormItemCheckRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InspectedResult")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("InspectionFormGroupRecordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InspectionFormGroupRecordId");

                    b.ToTable("ef_boq_site_inspection_form_item_check_record");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormItemGroup", b =>
                {
                    ...
                    b.ToTable("ef_boq_site_inspection_form_item_group");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormGroupRecord", b =>
                {
                    b.HasOne("ModelLayer.InspectionFormItemGroup", null)
                        .WithMany("FormGroupRecords")
                        .HasForeignKey("InspectionFormItemGroupId");

                    b.HasOne("ModelLayer.InspectionFormRecord", null)
                        .WithMany("FormGroupRecords")
                        .HasForeignKey("InspectionFormRecordId");
                });

            modelBuilder.Entity("ModelLayer.InspectionFormGroupRecordAttachment", b =>
                {
                    b.HasOne("ModelLayer.InspectionFormItemCheckRecord", null)
                        .WithMany("CheckAttachments")
                        .HasForeignKey("InspectionFormItemCheckRecordId");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormItemCheckRecord", b =>
                {
                    b.HasOne("ModelLayer.InspectionFormGroupRecord", null)
                        .WithMany("FormItemCheckRecords")
                        .HasForeignKey("InspectionFormGroupRecordId");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormRecord", b =>
                {
                    b.HasOne("ModelLayer.BoqSiteInspection", null)
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormGroupRecord", b =>
                {
                    b.Navigation("FormItemCheckRecords");
                });

            modelBuilder.Entity("ModelLayer.InspectionFormItemCheckRecord", b =>
                {
                    b.Navigation("CheckAttachments");
                });
