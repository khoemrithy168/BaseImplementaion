...
namespace BOM.API.Migrations
{
    ...
    [Migration("20250211032842_addItemTaskUomConversions")]
    partial class addItemTaskUomConversions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelLayer.GBApprovalCondition", b =>
                {
                    ...
                    b.ToTable("ef_globle_workflow_condition");
                });
            ...
            modelBuilder.Entity("ModelLayer.GBDocumentType", b =>
                {
                    ...
                    b.ToTable("ef_globle_workflow_document_type");
                });
            ...
            modelBuilder.Entity("ModelLayer.GBWorkflowApproval", b =>
                {
                    ...
                    b.ToTable("ef_globle_workflow_approval");
                });
            ...
            modelBuilder.Entity("ModelLayer.RequestLeaveApprovalDoc", b =>
                {
                    ...
                    b.ToTable("ef_request_leave_doc");
                });
            ...
            modelBuilder.Entity("ModelLayer.SapEmployeeMasterData", b =>
                {
                    ...
                    b.ToTable("ef_sap_employee_masterdata");
                });
            ...
            modelBuilder.Entity("ModelLayer.UnitOfMeasure", b =>
                {
                    ...
                    b.ToTable("ef_items_UnitOfMeasure");
                });
            ...
            modelBuilder.Entity("ModelLayer.WorkItemTaskUoMConversion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("workItemTaskUoMConversions");
                });
            ...
            modelBuilder.Entity("ModelLayer.WorkItemTaskUoMConversion", b =>
                {
                    b.HasOne("ModelLayer.WorkItemTaskUoM", "workItemTaskUoM")
                        .WithMany("ItemTaskUoMConversions")
                        .HasForeignKey("ItemUoMId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("workItemTaskUoM");
                });
            ...
            modelBuilder.Entity("ModelLayer.WorkItemTaskUoM", b =>
                {
                    b.Navigation("ItemTaskUoMConversions");
                });
