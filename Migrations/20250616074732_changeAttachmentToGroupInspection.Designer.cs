...
namespace BOM.API.Migrations
{
    ...
    [Migration("20250616074732_changeAttachmentToGroupInspection")]
    partial class changeAttachmentToGroupInspection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormGroupRecordAttachment", b =>
                {
                    b.HasOne("ModelLayer.InspectionFormGroupRecord", "InspectionFormGroupRecord")
                        .WithMany()
                        .HasForeignKey("FormGroupRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("InspectionFormGroupRecord");
                });
            ...
            modelBuilder.Entity("ModelLayer.InspectionFormItemCheckRecord", b =>
                {
                    ...
                    b.HasOne("ModelLayer.InspectionFormItemCheckList", "InspectionFormItemCheckList")
                        .WithMany()
                    ...
                    b.Navigation("InspectionFormItemCheckList");
                });
